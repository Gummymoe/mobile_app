...
window.addEventListener("DOMContentLoaded",
    ...
    function () {
        if (typeof localStorage === "underfined") {
            window.alert("このブラウザはLocal Storge 機能が実袋されていません");
            return;
        ...
        function (e) {
            ...
            if (w_sel === "1") {
                ...
                if (w_confirm === true) {
                    ...
                    viewStroage();
                    let w_msg = "LocalStoragenに" + key + " " + value + "を削除しました。";
                    window.alert(w_msg);
                    document.getElementById("textKey").value = "";
                    document.getElementById("textMemo").value = "";
                }
...
function allClearLocalStorage() {
    ...
    allClear.addEventListener("click",
        function (e) {
            e.preventDefault();
            let w_confirm = window.confirm("LocalStrogeのデータをすべて削除(all clear)します。\n よろしいですか？");
